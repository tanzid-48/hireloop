...
import { FiSearch, FiMapPin, FiBriefcase, FiBarChart2, FiUsers, FiStar } from 'react-icons/fi';
      ...
      <section className="relative z-10 flex flex-col items-center">
        ...
        <div className="relative w-full max-w-4xl mx-auto">
          ...
          <div className="absolute inset-0 flex items-center justify-center" style={{ paddingBottom: '8%' }}>
            <p className="text-3xl  md:text-5xl font-medium text-white/80 text-center max-w-lg leading-snug px-4">
              Assisting over{' '}
